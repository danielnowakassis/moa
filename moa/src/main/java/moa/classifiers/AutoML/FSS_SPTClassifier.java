...
/**
 * Fish School Search over a streaming hyperparameter space: a school of
 * candidates moves through the search space by individual, collective
 * instinctive and collective volitive steps, with the step size annealed from
 * {@code initialStep} down to {@code finalStep}.
 *
 ...
 */
public class FSS_SPTClassifier extends AbstractClassifier implements MultiClassClassifier,
    ...
    protected static class FishEntry implements Serializable {
        ...
        FishEntry(Classifier model, BasicClassificationPerformanceEvaluator evaluator,
                  ArrayList<Parameter> params) {
            this.model = model;
